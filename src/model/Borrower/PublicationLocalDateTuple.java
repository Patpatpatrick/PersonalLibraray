...
public final class PublicationLocalDateTuple<A,B>{
    private final A mFirst;
    private final B mSecond;

    public PublicationLocalDateTuple(final A first, final B second) {
        this.mFirst = first;
        this.mSecond = second;
    }
    ...
    public boolean equals(final Object obj) {
        ...
        final PublicationLocalDateTuple other = (PublicationLocalDateTuple) obj;
        if (this.mFirst == null) {
